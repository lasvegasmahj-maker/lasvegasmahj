...
const JOURNEYS: Journey[] = [
  ...
  { name: "stopping the Charleston", question: "Can I stop the Charleston?", answer: /compulsory/i, contradiction: /before the first across/i, page: /compulsory/, expectLink: true, label: /Standard rule/ },
  ...
  { name: "changing an exposure", question: "Do I have to expose tiles right away when I call?", answer: /up until you discard/i, contradiction: /cannot call and then decide/i, page: /up until you discard/, expectLink: true, label: /Standard rule/ },
