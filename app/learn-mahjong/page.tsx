...
const affiliates = [
  ...
  { name: "Mahjongg Maven", url: "https://mahjonggmaven.com/?ref=Lasvegasmahj", desc: "Everything a new player needs: sets, bags, tile holders, and accessories.", discount: "10% off with code LASVEGASMAHJ" },
