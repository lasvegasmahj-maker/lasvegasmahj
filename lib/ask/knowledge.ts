...
export const RULES_KNOWLEDGE: KnowledgeEntry[] = [
...

  {
    ...
    category: "basics",
    level: "foundational",
    question: "What is the order of play?",
    patterns: [/\border of play\b/, /\bwhose turn\b/, /which (way|direction).{0,20}(play|turn|go)/, /\b(counter ?clockwise|clockwise)\b/, /who (goes|plays) (first|next)/, /\bturn order\b/],
    keywords: ["order of play", "turn", "counterclockwise", "east"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["dealing", "calling-discard", "most-recent-discard"],
  },
  {
    id: "hand-size",
    category: "basics",
    level: "foundational",
    question: "How many tiles do I hold during play?",
    patterns: [/how many tile.{0,25}\b(hold|holding|keep|keeping)\b/, /how many tile.{0,20}\b(in|left in) (my|your) hand\b/, /\b(13|14) tile\b.{0,20}\b(hand|hold|turn)\b/, /\bhand size\b/, /how many tile.{0,15}\bsupposed to\b/, /\bbetween turn\b/],
    keywords: ["hand size", "hold", "13 tile", "14 tile"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["dealing", "dead-hand-triggers", "wrong-exposure"],
  },
  {
    id: "exposures-basics",
    category: "calling",
    level: "core",
    question: "What is an exposure?",
    patterns: [/what (is|are) ?(an |a |the )?expose\b/, /what.{0,12}\bexpose\b.{0,15}\b(mean|definition)\b/, /what does expose mean/, /\bdefine\b.{0,10}\bexpose\b/, /what exactly is (an |a )?expose\b/, /\bexpose\b.{0,20}\bpair\b/, /\bpair\b.{0,20}\b(count as|is) (an |a )?expose\b/],
    keywords: ["expose"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["expose-immediately", "wrong-exposure", "call-for-pair"],
  },
  {
    id: "quints-sextets",
    category: "basics",
    level: "advanced",
    question: "What is a quint and a sextet?",
    patterns: [/\b(quint|sextet)\b/, /what (is|are) ?(a |an |the )?(quint|sextet)/, /\b(quint|sextet)\b.{0,30}\b(joker|flower|identical|5|6|five|six)\b/, /\b(joker|flower)\b.{0,25}\b(quint|sextet)\b/, /\b(five|six) (identical|like|same) tile\b/, /\b(quint|sextet)\b.{0,20}\b(quint|sextet)\b/],
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["pung-vs-kong", "joker-substitute", "card-numbers"],
  },
  {
    id: "joker-in-mixed-groups",
    category: "jokers",
    level: "advanced",
    question: "Can I use a joker in a run or a year?",
    patterns: [/\bjoker\b.{0,30}\b(run|runs|year|years|consecutive|mixed)\b/, /\b(run|runs|year|years|consecutive)\b.{0,30}\bjoker\b/, /\bjoker\b.{0,25}\bsingle tiles?\b/],
    keywords: ["joker", "run", "year", "consecutive", "mixed"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["joker-substitute", "joker-in-news", "joker-singles-pairs-hand"],
  },
  {
    id: "naming-discards",
    category: "etiquette",
    level: "core",
    question: "Do I have to name my discard out loud?",
    patterns: [/\b(name|naming|say|saying|announce|announcing|call out)\b.{0,25}\bdiscard\b/, /\bdiscard\b.{0,25}\b(out loud|aloud|by name)\b/, /do i have to say\b/],
    keywords: ["name", "announce", "aloud", "discard"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["most-recent-discard", "call-window", "table-talk"],
  },
  {
    id: "picking-ahead",
    category: "etiquette",
    level: "core",
    question: "Can I draw before the player ahead of me discards?",
    patterns: [/\bpick(ing)? ahead\b/, /\bdraw\b.{0,30}\bbefore\b.{0,25}\bdiscard/, /\b(early|ahead of turn|out of turn)\b.{0,20}\b(draw|pick)\b/, /\b(draw|pick)\b.{0,20}\b(early|ahead)\b/],
    keywords: ["picking ahead", "draw early", "wait your turn"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["order-of-play", "call-window", "most-recent-discard"],
  },
  {
    id: "passing-on-a-discard",
    category: "calling",
    level: "core",
    question: "Do I have to call a discard I can use?",
    patterns: [/\b(do|does) (i|you|we) (have|need) to call\b.{0,25}\b(discard|tile)\b/, /\b(have to|need to|must i|obligated to) call\b.{0,25}\b(discard|tile)\b/, /\b(pass on|skip|decline|ignore|let it go|leave it)\b.{0,25}\b(discard|tile)\b/, /\b(do not|don't|didn't|did not) want\b.{0,20}\b(discard|tile)\b/, /\bnot call\b.{0,20}\bdiscard\b/],
    keywords: ["have to call", "decline", "pass on"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["call-window", "calling-discard", "most-recent-discard"],
  },
  {
    id: "card-notation",
    category: "card",
    level: "core",
    question: "What do the colors and letters on the card mean?",
    patterns: [/\b(color|colors|colour|colours)\b.{0,25}\bcard\b/, /\bcard\b.{0,25}\b(color|colors|colour|colours)\b/, /what does\b.{0,15}\b(c|x|f|d)\b.{0,15}\bmean\b/, /\b(letters?|notation|symbols?)\b.{0,25}\bcard\b/, /\bcard\b.{0,20}\b(letters?|notation|symbols?)\b/],
    keywords: ["colors", "letters", "notation", "concealed marking"],
    answer:
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["card-numbers", "any-like-number", "consecutive-numbers"],
  },
  {
    id: "tournament-rules",
    category: "etiquette",
    level: "advanced",
    question: "Are tournament rules different?",
    patterns: [/\btournament\b/, /\bdirector'?s? rules?\b/],
    ...
    confidence: "high",
    source: "shared_approved",
    related: ["house-vs-nmjl", "courtesies-vs-rules", "annual-card"],
  },
  {
    id: "blank-tiles",
    category: "tiles",
    level: "advanced",
    question: "What are blank tiles for?",
    patterns: [/\bblanks?\b/, /\bblank tiles?\b/],
    keywords: ["blank", "blanks", "spare tile"],
    answer:
    ...
    varies_by_house: true,
    house_note:
      "Blank rules differ from table to table by design.",
    confidence: "high",
    source: "shared_approved",
    related: ["house-vs-nmjl", "courtesies-vs-rules", "joker-substitute"],
  },
